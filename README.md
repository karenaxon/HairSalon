# Hair Salon
This website lets users add a hair stylist and his/her clients to a database. The stylists have specific specialties, so each client can only see (belong to) a single stylist (a one-to-many relationship).
...
* Click on the [repository's](https://github.com/karenaxon/HairSalon.git) link.
